...
# Sprawdź czy kolumna score_st istnieje i ma wartości w wynikach.
# Stary skan (przed v1.1) nie będzie miał tej kolumny w ogóle lub będzie NULL.
has_score_st = any(r.get("score_st") is not None for r in results)
brak_st = jest_st and not has_score_st
if brak_st:
    st.warning(
