...
export function AppShell({ children }: AppShellProps) {
  ...
  return (
    // AuthGuard chroni WSZYSTKIE strony aplikacji naraz — landing (/welcome)
    // i /login nie używają AppShell, więc pozostają publiczne. Dzięki temu
    // nie da się zapomnieć o żadnej stronie ani zostawić niespójnego stanu,
    // gdzie część paneli działa mimo wylogowania.
    <AuthGuard>
